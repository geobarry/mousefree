...
<user.key> {user.slow_repeater_speed_word}: user.start_key_repeat("{key}",slow_repeater_speed_word)

{user.slow_repeater_speed_word} repeat: user.start_cmd_repeat(slow_repeater_speed_word)
