...
# SHORTCUTS FOR GENERIC WINDOW ELEMENTS
#  will work usually but definitely not always
...
mouse to right panel:
	...
	user.compass_enable(0,1)	
mouse to window close button:
	user.mouse_to_active_window_handle("upper right",100,-25,20)
	user.compass_enable(0,1)
